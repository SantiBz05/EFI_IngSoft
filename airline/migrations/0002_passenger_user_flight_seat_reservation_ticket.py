# Generated by Django 5.2.3 on 2025-07-02 23:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plane_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='airline.plane')),
                ('user_id', models.ManyToManyField(to='airline.user')),
            ],
        ),
        migrations.CreateModel(
            name='Seat',
